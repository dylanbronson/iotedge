...
namespace Microsoft.Azure.Devices.Edge.Hub.Core.Test.Routing
{
    ...
    public class CloudMessageProcessorTests
    {
        ...
        public void BasicTest()
        {
            ...
            Task<Option<ICloudProxy>> GetCloudProxy(string id, Option<string> _) => Task.FromResult(Option.Some(cloudProxyMock.Object));
        ...
        public async Task ProcessAsyncTest()
        {
            ...
            Task<Option<ICloudProxy>> GetCloudProxy(string id, Option<string> _)
            {
        ...
        public async Task NoErrorFromCloudProxy_NoErrorDetailsReturned()
        {
            ...
            Task<Option<ICloudProxy>> GetCloudProxy(string id, Option<string> _) => Task.FromResult(Option.Some(cloudProxy));
        ...
        public async Task TransientErrorOfFirstIdentity_DoesNotFastFailsSecondIdentity_ButReportsError()
        {
            ...
            Task<Option<ICloudProxy>> GetCloudProxy(string id, Option<string> _) => Task.FromResult(Option.Some(proxyMap[id]));
