...
namespace Microsoft.Azure.Devices.Edge.Hub.Core.Test.Routing
{
    ...
    public class CloudEndpointTest
    {
        ...
        public void CloudEndpoint_MembersTest()
        {
            ...
            var cloudEndpoint = new CloudEndpoint(cloudEndpointId, (id, _) => Task.FromResult(Option.Some(cloudProxy)), routingMessageConverter);
        ...
        public void CloudMessageProcessor_CloseAsyncTest()
        {
            ...
            var cloudEndpoint = new CloudEndpoint(cloudEndpointId, (id, modelId) => Task.FromResult(Option.Some(cloudProxy)), routingMessageConverter);
        ...
        public async Task Events_CloudProxyNotFoundTest()
        {
            ...
            Mock.Get(routingMessage).Setup(rm => rm.SystemProperties).Returns(new Dictionary<string, string> { { "connectionDeviceId", "myConnectionDeviceId" } });
            var cloudEndpoint = new CloudEndpoint(cloudEndpointId, (id, _) => Task.FromResult(Option.None<ICloudProxy>()), routingMessageConverter);
        ...
        public async Task RetryableExceptionsTest(Exception exception, bool isRetryable)
        {
            ...
            var cloudEndpoint = new CloudEndpoint(Guid.NewGuid().ToString(), (_, __) => Task.FromResult(Option.Some(cloudProxy.Object)), new RoutingMessageConverter());
            IProcessor processor = cloudEndpoint.CreateProcessor();
