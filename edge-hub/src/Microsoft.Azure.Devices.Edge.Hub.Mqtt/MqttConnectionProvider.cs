...
namespace Microsoft.Azure.Devices.Edge.Hub.Mqtt
{
    ...
    public class MqttConnectionProvider : IMqttConnectionProvider
    {
        ...
        public async Task<IMessagingBridge> Connect(IDeviceIdentity deviceidentity)
        {
            ...
            IDeviceListener deviceListener = await this.connectionProvider.GetDeviceListenerAsync(protocolGatewayIdentity.ClientCredentials.Identity, protocolGatewayIdentity.DeviceCapabilityModelId);
