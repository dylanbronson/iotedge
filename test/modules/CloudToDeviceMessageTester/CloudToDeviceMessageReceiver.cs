            ...
            try
            {
                ...
                while (!ct.IsCancellationRequested)
                {
                    ...
                    try
                    {
                        ...
                        this.logger.LogInformation($"Message received. MessageId: {message.MessageId}. CorrelationId: {message.CorrelationId}");
                        string correlationId = message.Properties["correlation-id"];
                        string messageId = message.Properties["message-id"];
                        this.logger.LogInformation($"messageId: {messageId} and correlationId: {correlationId}");
