                ...
                builder =>
                {
                    builder.AddModule(trcModuleName, trcImage)
                       .WithEnvironment(new[]
                       {
                           ...
                           ("eventHubConnectionString", "Endpoint=sb://dybronsoeventhub.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=7ycWedM+hFb8+PKGO2ST7Z9Q7X7VlWB1BSczFAnOs38="),
